  ...
  Future<void>profileUpdate() async {
    ...
    if(response.isSuccess){
     ...
     Authutility.updateUserInfo(userData);
      ...
      if(mounted){
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text (' Profile Updated Sucessfully')));
      } else {
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      width: double.infinity,
                      child: _profileInProgress ? const Center( child: CircularProgressIndicator() ) :
                      ElevatedButton(
                        onPressed: () {
                           profileUpdate();
                        },
