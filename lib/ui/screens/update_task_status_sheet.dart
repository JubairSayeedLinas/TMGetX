...
class UpdateTaskStatusSheet extends StatefulWidget {
  ...
  const UpdateTaskStatusSheet({Key? key, required this.task, required this.onUpdate}) : super(key: key);
    ...
    if (response.isSuccess) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(' Update Status failed'),));
      }
    }
  }
            ...
            child: ListView.builder(
                ...
                itemBuilder:
                  ...
                  return ListTile(
                    ...
                    trailing: _selectedTask == taskStatusList[index] ? Icon(Icons.check) : null,
                  );
                }
            ),
          ),
